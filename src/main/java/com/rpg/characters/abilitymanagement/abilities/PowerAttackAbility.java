...
public class PowerAttackAbility implements Ability {
    ...
    public AbilityOutcome execute(AbilityContext ctx) {
        ...
        var meta = AbilityRegistry.getAbilityMetadata(AbilityId.POWER_ATTACK);
        int damage = p.calculateDamageDoneByPlayer(e.getDefense(), 2, AttackBonusType.ADDITIVE);
        ...
        return new AbilityOutcome(
                ...
                e.getHealthPoints(),
                List.of("You use " + meta.name() + "!", "You dealt " + damage + " damage.")
        );
    }
